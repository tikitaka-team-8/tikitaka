...
# 호출 위치와 관계없이 S08 load 디렉터리의 절대 경로를 계산합니다.
...
FAILURE_PROFILE=mixed "${SCRIPT_DIR}/../inject/inject-failure-events.sh" payment &
INJECTOR_PID=$!

k6 run "${SCRIPT_DIR}/kafka-failure-recovery.js"
