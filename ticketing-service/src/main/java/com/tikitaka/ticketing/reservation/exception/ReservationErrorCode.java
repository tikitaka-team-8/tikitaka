...
public enum ReservationErrorCode implements ErrorCode {
    ...
    IDEMPOTENCY_KEY_REUSED("R-016", HttpStatus.CONFLICT, "동일한 멱등키를 다른 예매 요청에 사용할 수 없습니다."),
    INTERNAL_SERVICE_AUTHENTICATION_FAILED("R-017", HttpStatus.UNAUTHORIZED, "내부 서비스 인증에 실패했습니다.");
